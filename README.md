...
научился пользоваться ngrok, понял суть API и AUTH2.0 amoCRM, изучил создание докера с Postgres обычно у меня был MySQL, изучил помошника Laravel Sail. Надеюсь пройду этап 1 с такими ошибками. Всем хорошего дня!!!
